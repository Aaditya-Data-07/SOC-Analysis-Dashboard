...
- Monitor SOC operations in real time.
- Improve incident response efficiency.
- Identify critical security risks.
- Track analyst performance.
- Monitor SLA compliance.
- Support management decision-making with interactive visual analytics.
- Enhance visibility into cybersecurity operations.

---

# 📸 Dashboard Preview

The project consists of six interactive Power BI pages:
...
---
**Developed as a portfolio project to demonstrate advanced Power BI, DAX, data modeling, and cybersecurity analytics skills using a large-scale SOC dataset.**
